...
async function checkarts() {
    ...
    try {
        ...
        json.message.forEach(info => {
            ...
            s.innerHTML += "<div class=\"col\"><div class=\"card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg\" style=\"background-image: url("+img+");\"><div class=\"d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1\"><h3 class=\"pt-5 mt-5 mb-4 display-6 lh-1 fw-bold\">"+title+"</h3><ul class=\"d-flex list-unstyled mt-auto\"><li class=\"me-auto\"><button type=\"button\" onclick=\"window.location = '/view?id="+id+"'\"class=\"btn btn-primary\">Vai</button></li><li class=\"d-flex align-items-center\"><i class=\"bi bi-calendar-fill me-1\"></i><small>"+date+"</small></li></ul></div></div>"
        });
    } catch (error) {
